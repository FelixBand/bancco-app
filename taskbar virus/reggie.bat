reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows Defender" /v DisableWinDefender /t REG_DWORD /d 1 /f
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Microsoft Defender" /v DisableAntiSpyware /t REG_DWORD /d 1 /f
reg add "HKCU\Control Panel\Desktop" /v Wallpaper /t REG_SZ /d "%CD%\backgound.png" /f
reg add "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Narrator" /v AutoreadAdvancedInfo /t REG_DWORD /d 1 /f
reg add "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Narrator" /v CoupleNarratorCursorKeyboard /t REG_DWORD /d 1 /f
reg add "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Narrator" /v CoupleNarratorCursorMouse /t REG_DWORD /d 1 /f
reg add "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Narrator" /v EchoChars /t REG_DWORD /d 1 /f
reg add "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Narrator" /v EchoWords /t REG_DWORD /d 1 /f
reg add "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Narrator" /v ErrorNotificationType /t REG_DWORD /d 1 /f
reg add "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Narrator" /v FollowInsertionPoint /t REG_DWORD /d 1 /f
reg add "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Narrator" /v HearOnlySoundsForCommonActions /t REG_DWORD /d 0 /f
reg add "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Narrator" /v InteractionMouse /t REG_DWORD /d 1 /f
reg add "HKEY_CURRENT_USER\SOFTWARE\Microsoft\Narrator" /v KeyboardLayout /t REG_DWORD /d 1 /f
...
reg add "HKCU\Software\Microsoft\Windows\CurrentVersion\Themes" /v HighContrast /t REG_SZ /d 1 /f
...
reg add "HKEY_USERS\S-1-5-19\Console" /v CtrlKeyShortcutsDisabled /t REG_DWORD /d 1 /f
reg delete "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\MyComputer\NameSpace{645FF040-5081-101B-9F08-00AA002F954E}" /f
